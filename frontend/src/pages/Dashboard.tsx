    ...
    >
      ...
      >
        ...
        <div
          ...
          style={{
            background: 'linear-gradient(135deg, #4a67e8, #6080f5)',
            color: 'white',
            borderRadius: '16px',
            padding: '24px',
            boxShadow: '0 4px 18px rgba(96,128,245,0.28)',
          }}
        >
          <div
            style={{
          ...
          {loading ? (
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px', opacity: 0.8 }}>
              <Spinner size={18} />
              <span style={{ fontSize: '14px' }}>Loading wallets…</span>
            </div>
          ) : wallets.length === 0 ? (
            <div>
              ...
              <p style={{ fontSize: '13px', opacity: 0.8, marginBottom: '16px' }}>
                Connect MetaMask to start receiving payments
              </p>
              <Link
                to="/wallet"
                style={{
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                {wallets.slice(0, 3).map((w) => (
                  ...
                  >
                    ...
                    <span style={{ opacity: 0.75, fontSize: '11px', textTransform: 'capitalize' }}>
                      {w.network}
                    </span>
                  </div>
                ))}
        ...
        >
          <h3
            style={{ fontSize: '18px', fontWeight: '600', marginBottom: '20px', color: '#e2e8f0' }}
          >
            Quick Actions
          </h3>
          <div
              ...
              {transactions.slice(0, 5).map((tx) => (
                ...
                >
                  <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                    ...
                    <div>
                      <p style={{ fontWeight: '500', fontSize: '14px', color: '#e2e8f0' }}>
                        {tx.id.slice(0, 8)}...
                      </p>
                  ...
                  <div style={{ textAlign: 'right' }}>
                    <p
                      style={{
                        fontWeight: '600',
                        color: tx.type === 'receive' ? '#34d399' : '#e2e8f0',
                      }}
                    >
                      {tx.type === 'receive' ? '+' : '-'}
