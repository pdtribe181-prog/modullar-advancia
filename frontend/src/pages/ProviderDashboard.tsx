...
export default function ProviderDashboard() {
  ...
  const [activeTab, setActiveTab] = useState<'appointments' | 'profile' | 'earnings'>(
    'appointments'
  );
  ...
  async function loadAppointments() {
    try {
      const data = await api.get<{ appointments: Appointment[] }>(
        '/provider/appointments?upcoming=true'
      );
  ...
  if (!provider) {
    return (
      <div style={{ maxWidth: '860px', margin: '0 auto', padding: '32px 24px' }}>
        <h1 style={{ fontSize: '26px', fontWeight: '700', color: '#e2e8f0', marginBottom: '20px' }}>
          Provider Dashboard
        </h1>
        <div
          style={{
  ...
  return (
    <div style={{ maxWidth: '1060px', margin: '0 auto', padding: '32px 24px' }}>
      ...
      >
        ...
        >
          <h3 style={{ color: '#94a3b8', fontSize: '13px', margin: '0 0 8px' }}>
            Upcoming Appointments
          </h3>
          <p style={{ fontSize: '28px', fontWeight: '700', color: '#e2e8f0', margin: 0 }}>
        ...
        >
          ...
          <p style={{ fontSize: '28px', fontWeight: '700', color: '#e2e8f0', margin: 0 }}>
            ${earnings?.stripeBalance?.available || 0}
          </p>
        </div>
      </div>
      ...
      {activeTab === 'appointments' && (
        <div>
          <h2
            style={{ fontSize: '18px', fontWeight: '600', color: '#e2e8f0', marginBottom: '16px' }}
          >
            Upcoming Appointments
          </h2>
            ...
            >
              ...
              >
                ...
                <div style={{ display: 'flex', gap: '8px', justifyContent: 'flex-end' }}>
                  ...
                  <button
                    onClick={() => handleComplete(showNotesModal)}
                    style={{
                      padding: '8px 16px',
                      borderRadius: '6px',
                      border: 'none',
                ...
                <div style={{ display: 'flex', gap: '8px', justifyContent: 'flex-end' }}>
                  ...
                  <button
                    ...
                    style={{
                      ...
                      borderRadius: '6px',
                      border: 'none',
                      background: cancelReason.trim() ? '#ef4444' : '#374151',
                      color: 'white',
        ...
        <div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '16px' }}>
            ...
            >
              ...
              <p style={{ fontSize: '36px', fontWeight: '700', color: '#34d399', margin: 0 }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                    ...
                    <span style={{ fontWeight: '700', color: '#34d399' }}>
                      ${earnings.stripeBalance.available}
                    </span>
                  </div>
                  <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                    <span style={{ color: '#94a3b8', fontSize: '14px' }}>Pending:</span>
                    <span style={{ fontWeight: '700', color: '#e2e8f0' }}>
                      ${earnings.stripeBalance.pending}
                    </span>
                  </div>
                </div>
              </div>
      ...
      {/* Profile Tab */}
      {activeTab === 'profile' && <ProviderProfile provider={provider} onUpdate={loadProvider} />}
    </div>
  );
}
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
          {[
            ...
            <div key={label} style={{ display: 'flex', alignItems: 'baseline', gap: '8px' }}>
              <span style={{ color: '#64748b', fontSize: '13px', minWidth: '140px' }}>
                {label}:
              </span>
              <span
                style={{ color: bold ? '#e2e8f0' : '#94a3b8', fontWeight: bold ? '600' : '400' }}
              >
                {value}
              </span>
            </div>
          ...
          <div>
            ...
            <p style={{ color: '#94a3b8', marginTop: '6px', lineHeight: '1.6' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
            ...
            <span
              style={{
                color: provider.stripe_onboarding_complete ? '#34d399' : '#fde047',
                fontWeight: '500',
                fontSize: '13px',
              }}
            >
