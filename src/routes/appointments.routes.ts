...
import { validateBody, validateQuery, validateParams, uuidSchema, createAppointmentSchema, paginationSchema } from '../middleware/validation.middleware.js';
 ...
 */
router.get('/providers/:providerId/availability', validateParams(providerIdParamsSchema), validateQuery(availabilityQuerySchema), asyncHandler(async (req, res: Response) => {
 ...
 */
router.get('/providers', validateQuery(providersQuerySchema), asyncHandler(async (req, res: Response) => {
  const { specialty, limit, offset } = req.query as unknown as { specialty?: string; limit: number; offset: number };
 ...
 * Book an appointment
 */
router.post('/book', authenticate, validateBody(bookAppointmentSchema), asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
 ...
 */
router.get('/my-appointments', authenticate, asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
  const userId = req.user?.id;
 ...
 */
router.get('/:id', authenticate, validateParams(idParamsSchema), asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
  const userId = req.user?.id;
 ...
 */
router.post('/:id/cancel', authenticate, validateParams(idParamsSchema), validateBody(cancelAppointmentSchema), asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
  const userId = req.user?.id;
  const appointmentId = req.params.id;
 ...
 */
router.post('/:id/reschedule', authenticate, validateParams(idParamsSchema), validateBody(rescheduleAppointmentSchema), asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
  const userId = req.user?.id;
  const appointmentId = req.params.id;
